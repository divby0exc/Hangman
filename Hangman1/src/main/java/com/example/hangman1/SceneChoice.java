...
public class SceneChoice {
    ...
    private String howToPlayMultiplayer = "Du ska komma på ett ord för den andre spelarens gubbe. Den andre spelaren ska försöka gissa ordet genom att trycka på en bokstav i taget. Det går såklart bra att även trycka på tangenterna också. ";
    private String howToPlaySingleplayer = "Du får ett ord av datorn som du ska gissa. Du kan trycka på bokstäverna på skärmen eller på tangentbordet. ";
    private String howToPlayEnd = "Du har 10 försök på dig. Du ser när strecken ritas på skärmen men även försöken ovanför bokstäverna så du slipper komma ihåg allt.";
    private String howToPlayInteractive = "I detta läge kan du bestämma själv hur många streck som ska ritas. Det betyder att ni bestämmer själva om det ska gå fort eller om ni vill rita mer streck så spelet blir längre. När gubben är hängd så är spelet över. ";
    ...
    public javafx.scene.Scene gameMenu(Stage stage) {
        ...
        playGame.setOnAction(e -> stage.setScene(mainGame()));
        Button mode = new Button("Svårighetsgrad");
        //mode.setOnAction(e -> stage.setScene(sceneArr[]));
