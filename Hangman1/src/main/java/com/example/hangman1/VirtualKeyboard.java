...
public class VirtualKeyboard {
    ...
    public VBox createKeyBoard(EventHandler<ActionEvent> keyPressedEventHandler) {
        ...
        HBox keyboardRow1 = createButtonsOfRow(lettersRow1, keyPressedEventHandler);
        HBox keyboardRow2 = createButtonsOfRow(lettersRow2, keyPressedEventHandler);
        HBox keyboardRow3 = createButtonsOfRow(lettersRow3, keyPressedEventHandler);
    ...
    public HBox createButtonsOfRow(List<String> letters, EventHandler<ActionEvent> keyPressedEventHandler) {
        HBox hBox = new HBox();
